...
class _UserPostState extends State<UserPost> {
  ...
  Future<void> fetchlanguages()async{
    ...
    http.Response response=await http.get(Uri.parse("https://powerful-shelf-35750.herokuapp.com/api/language"));
  ...
  Future<void> fetchdomain()async{
    ...
    http.Response response=await http.get(Uri.parse("https://powerful-shelf-35750.herokuapp.com/api/postcategory"));
    var data=jsonDecode(response.body);
    print(data);
    setState((){
      domainsdata=data;
  ...
  Future<void> fetchsubdomain()async{
    ...
    http.Response response=await http.get(Uri.parse("https://powerful-shelf-35750.herokuapp.com/api/postsubcategory/$selecteddomain"));
    var data=jsonDecode(response.body);
    print(data);
    setState((){
      subdomainsdata=data;
  ...
  Future postUpload()async{
    allphanesuserdata=await SharedPreferences.getInstance();
    final uri=Uri.parse("https://powerful-shelf-35750.herokuapp.com/api/posts/genarate");
