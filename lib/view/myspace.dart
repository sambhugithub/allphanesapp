...
class _MySpaceState extends State<MySpace> with TickerProviderStateMixin{
  ...
  Future<void> fetchnumberofpost()async{
    ...
    http.Response response=await http.get(Uri.parse("https://powerful-shelf-35750.herokuapp.com/api/services/numOfPost/62a6e09582ad207566bc1384/$userid"));
    var data=jsonDecode(response.body);
    print(data);
    setState((){
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text("${myspacedata["responseData"][index]["postDescription"]}",style: TextStyle(color: Colors.black,fontSize: 14),textAlign: TextAlign.justify,),
                                        ),
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  padding: const EdgeInsets.all(8.0),
                                                  child: Image(image: CachedNetworkImageProvider('${myspacedata["responseData"][index]["shareGalleryInfo"]}'),fit: BoxFit.contain,),
                                                ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                                              Text("${myspacedata["responseData"][index]["totalLikes"]} Likes  ${myspacedata["responseData"][index]["totalComment"]} Comments",style: TextStyle(color: Colors.grey,fontSize: 12),),
                                            ],
                                          ),
                                        ),
